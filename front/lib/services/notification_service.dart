  ...
  Future<void> _setupFirebase() async {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      if (message.notification != null) {
        ...
        // Here you would typically show a local in-app notification (e.g., flushbar or snackbar)
        // Since we don't have a global context here easily, we rely on the app's UI to handle it 
        // or use a package like flutter_local_notifications if needed.
      }
    });
  }
